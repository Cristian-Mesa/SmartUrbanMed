<%@ Page Title="Servicios" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
  CodeBehind="Servicios.aspx.cs" Inherits="SmartUrban.Servicios" %>
  ...
  <asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="page-hero animate-up">
      ...
      <div style="text-align:right">
        ...
        <div style="font-size:.72rem;color:var(--muted);text-transform:uppercase;letter-spacing:.08em">Servicios activos
        </div>
      </div>
    </div>
    ...
    <div class="serv-grid animate-up delay-2">
      ...
      <div class="serv-card" data-cat="plomeria">
        ...
        <div class="serv-body">
          ...
          <div class="serv-desc">Detección y reparación de fugas, cambio de tuberías, instalación de llaves y grifos en
            cualquier zona de Medellín.</div>
          <div class="serv-footer">
            <div class="serv-proveedor">🏪 Fix Home <span class="badge badge-verde"
                style="margin-left:.35rem">Disponible</span></div>
      ...
      <div class="serv-card" data-cat="electricidad">
        ...
        <div class="serv-body">
          ...
          <div class="serv-desc">Instalación de tomas, switchs, paneles eléctricos, iluminación LED y revisión de redes
            eléctricas completas.</div>
          <div class="serv-footer">
            <div class="serv-proveedor">🏪 Electro MED <span class="badge badge-verde"
                style="margin-left:.35rem">Disponible</span></div>
            <a href="SolicitarServicio.aspx" class="btn-solicitar">Solicitar →</a>
          </div>
        </div>
      ...
      <div class="serv-card" data-cat="carpinteria">
        ...
        <div class="serv-body">
          ...
          <div class="serv-desc">Diseño y fabricación de cocinas integrales, closets, bibliotecas y todo tipo de muebles
            en madera y MDF.</div>
          <div class="serv-footer">
            <div class="serv-proveedor">🏪 Carpintería Ríos <span class="badge badge-oro"
                style="margin-left:.35rem">Ocupado</span></div>
            <a href="SolicitarServicio.aspx" class="btn-solicitar">Solicitar →</a>
          </div>
        </div>
      </div>
      ...
      <div class="serv-card" data-cat="pintura">
        ...
        <div class="serv-body">
          ...
          <div class="serv-desc">Pintura de paredes, techos y fachadas. Acabados decorativos, texturas y aplicación de
            pintura anticorrosiva.</div>
          <div class="serv-footer">
            <div class="serv-proveedor">🏪 PintaMed <span class="badge badge-purple"
                style="margin-left:.35rem">Disponible</span></div>
            <a href="SolicitarServicio.aspx" class="btn-solicitar">Solicitar →</a>
          </div>
        </div>
      ...
      <div class="serv-card" data-cat="jardineria">
        ...
        <div class="serv-body">
          ...
          <div class="serv-desc">Diseño paisajístico, siembra de plantas, poda, mantenimiento de jardines y terrazas
            verdes en altura.</div>
          <div class="serv-footer">
            <div class="serv-proveedor">🏪 Verde Urbano <span class="badge badge-leaf"
                style="margin-left:.35rem">Disponible</span></div>
            <a href="SolicitarServicio.aspx" class="btn-solicitar">Solicitar →</a>
          </div>
        </div>
      ...
      <div class="serv-card" data-cat="electricidad">
        ...
        <div class="serv-body">
          ...
          <div class="serv-desc">Instalación de cableado estructurado, cámaras de seguridad, puntos de red y sistemas de
            domótica básica.</div>
          <div class="serv-footer">
            <div class="serv-proveedor">🏪 TechFix <span class="badge badge-rojo"
                style="margin-left:.35rem">Inactivo</span></div>
            <a href="SolicitarServicio.aspx" class="btn-solicitar">Solicitar →</a>
          </div>
        </div>
      </div>
